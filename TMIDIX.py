...
def Tegridy_SONG_to_MIDI_Converter(SONG,
    ...
    with open(output_file_name + '.midi', 'wb') as midi_file:
...
def Tegridy_ms_SONG_to_MIDI_Converter(SONG,
                                      ...
                                      list_of_MIDI_patches = [0, 24, 32, 40, 42, 46, 56, 71, 73, 0, 0, 0, 0, 0, 0, 0],
                                      output_file_name = 'TMIDI-Composition',
                                      output_directory="/Users/jiabei/Desktop/music_test/Allegro-Music-Transformer/templates",
                                      text_encoding='ISO-8859-1',
                                      verbose=True):
    ...
    midi_data = score2midi(output, text_encoding)
    detailed_MIDI_stats = score2stats(output)
    output_path = os.path.join(output_directory, output_file_name + '.mid')
