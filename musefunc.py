...
def instantiate(full_path_to_model_checkpoint, model_precision):
    ...
    device_type = 'cpu'  # Running on CPU
    ...
    model.load_state_dict(torch.load(full_path_to_model_checkpoint, map_location=torch.device('cpu')))  # Loading to CPU
...
if plot_tokens_embeddings:
    ...
    if select_seed_MIDI == "Upload your own custom MIDI":
        ...
        f = '/Users/jiabei/Desktop/music_test/Allegro-Music-Transformer/Seeds/' + "Allegro-Music-Transformer-MI-Seed-1" + '.midi'
    ...
    if f != '':
        ...
        fname = '/Users/jiabei/Desktop/music_test/Allegro-Music-Transformer/Allegro-Music-Transformer-Seed-Composition'

        x = []
        y = []
        c = []

        colors = ['red', 'yellow', 'green', 'cyan', 'blue', 'pink', 'orange', 'purple', 'gray', 'white', 'gold',
                  'silver']
        ...
        if render_MIDI_to_audio:
            FluidSynth("/Users/jiabei/Desktop/music_test/Allegro-Music-Transformer/FluidR3_GM.sf2", 16000).midi_to_audio(str(fname + '.mid'),
                                                                                    str(fname + '.wav'))
...
number_of_tokens_to_generate = 330 # @param {type:"slider", min:33, max:1023, step:3}
...
for i in range(number_of_batches_to_generate):
  ...
  if len(out) != 0:
      ...
      detailed_stats = TMIDIX.Tegridy_ms_SONG_to_MIDI_Converter(song_f,
                                                                output_signature = 'Allegro Music Transformer',
                                                                output_file_name = '/Users/jiabei/Desktop/music_test/Allegro-Music-Transformer/Allegro-Music-Transformer-Music-Composition_'+str(i),
                                                                track_name='Project Los Angeles',
      ...
      fname = 'Allegro-Music-Transformer-Music-Composition_'+str(i)
      ...
      if True:
        FluidSynth("/Users/jiabei/Desktop/music_test/Allegro-Music-Transformer/FluidR3_GM.sf2", 16000).midi_to_audio(str(fname + '.mid'), str(fname + '.wav'))
        display(Audio(str(fname + '.wav'), rate=16000))
